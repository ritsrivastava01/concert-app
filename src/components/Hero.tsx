  ...
  return (
    <section className="bg-fix flex h-[calc(100vh-200px)] min-h-[400px] flex-col items-center justify-center bg-slate-600 bg-[url('/images/hero.jpg')] bg-cover bg-center text-zinc-200">
      <div className="rounded-xl bg-white/30 px-4 py-2 text-center backdrop-blur-md">
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute top-[95px] flex items-center justify-center">
            <div className="flex size-14 items-center justify-center gap-1 rounded-full bg-pink-500 *:w-1 *:rounded-full">
      ...
      <form className="mt-3 flex gap-2">
        <input
          className="rounded-md border border-white/40 bg-white/30 p-2 text-sky-900 placeholder-zinc-200 caret-pink-500 outline-pink-500 backdrop-blur-md focus:outline"
          type="email"
          placeholder="Email"
        />
